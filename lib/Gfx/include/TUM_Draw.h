...
/**
 * @brief reseting Array colors to black in all positions
 */
void colorArray();

/**
 * @brief Checking if the color at Position (x1,y1) is same as given color
 *
 * @param x1 X coordinate of the checking Pixel
 * @param y1 Y coordinate of the checking Pixel
 * @param colorr RGB colour of the checking Pixel
 * @return 1 if color is same colour as on screen
 * @return 0 if color is diffrent as on screen
 */
